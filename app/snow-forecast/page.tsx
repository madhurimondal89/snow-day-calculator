...
export const metadata: Metadata = {
  title: 'Snow Forecast & Live Winter Radar Map | Snow Day Calculator Free',
  description:
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://snowdaycalculatorfree.com'}/snow-forecast`,
  },
};
